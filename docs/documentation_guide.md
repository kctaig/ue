...
## 0. 一句话概括               ★ 让人 10 秒抓住要点
## 1. 涉及文件                 ★ 表格：文件 · 角色（见 §6 关键文件索引）
## 2. <正文分章...>            正文：概念 → 数据流图 → 逐项详解
...
## N. 验证 / 落地清单          ★ 怎么确认改动生效（勾选项）
## 附录                       可选：术语表 / 关键文件索引 / 自检命令
```
...
| 文件 | 符号 | 职责 |
|---|---|---|
| `docs/documentation_guide.md` | 本规范 | 文档编写规则 |
| `docs/doc_template.md` | 模板 | 新建文档起点 |
| `docs/README.md` | 索引 | 文档目录单一事实来源 |
| `CODE_STYLE.md`（仓库根） | `Comments: English only` | 源码注释语言约束（§8 依据） |
